...
## Payscript
[Payscript] is a Domain Specific Language (DSL) focused on the financial services domain. It implements functions such as fund transfers, checks, and scheduling, while inherently respecting regulatory constraints.

The language is built atop Apache Groovy, being syntax-compatible with both it and Java, which eases its adoption by development teams.
...
[Tutorial1]: docs/tutorials/tutorial1
[LanguageReference]: docs/language_reference